...
names={145:'Talbot Cathedral',146:'Elliptic Eyes',148:'Phason Tide'}
sheet=Image.new('RGB',(1650,404),'white')
...
print('Built three visible exact-preset thumbnails, sharing preview and comparison sheet; archived Spinor retained.')
